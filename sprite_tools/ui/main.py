...
class LoadedImagesPanel(QWidget):
    def __init__(
        ...
        self.search_edit.setMinimumWidth(72)
        ...
        self.jump_edit.setMinimumWidth(72)
        self.jump_edit.setMaximumWidth(220)
        self.jump_edit.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        ...
        sprite_actions.addWidget(self.zoom_value_label)
        sprite_actions.addStretch(1)
